...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference('Competence.count') do
      post competences_url, params: { competence: { ancestry: @competence.ancestry, title: @competence.title } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { ancestry: @competence.ancestry, title: @competence.title } }
